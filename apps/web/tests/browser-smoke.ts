...
async function assertServedBundle(): Promise<void> {
  ...
  try {
    ...
    assertBundleMarkers(script, [
      ...
      ["live evidence review", "Live evidence"],
      ["live evidence marker", "evidence-review-marker"],
      ["raw redacted evidence", "Raw redacted evidence JSON"],
      ["artifact modal", "Document artifact preview"],
      ["evidence json preview", "Evidence JSON preview"],
