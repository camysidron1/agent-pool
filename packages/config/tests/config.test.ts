  ...
  test("uses deterministic operator and control-plane defaults in test auth mode", () => {
    expect(loadConfig({ AUTH_MODE: "test" })).toEqual({
      ...
      controlPlane: {
        ...
        smokeFixtureRepositoryAllowlist: [],
  ...
  test("loads explicit control-plane config in non-test auth mode", () => {
    expect(
      loadConfig({
        ...
        AGENT_POOL_SMOKE_FIXTURE_REPOSITORIES: "https://github.com/example/tiny-fixture.git, https://github.com/example/other-fixture.git",
      ...
      controlPlane: {
        ...
        smokeFixtureRepositoryAllowlist: ["https://github.com/example/tiny-fixture.git", "https://github.com/example/other-fixture.git"],
